...
Explicação de como deve ser utilizado o projeto 🛠️ Utiliza a Classe GerenciamentoFrutas com o uso de Scanner para o usuário conseguir interagir na tela, após isso mostra 5 opções para ele em relação ao que vai querer fazer (Escolher fruta, listar todas as frutas, remover frutas, verficar se as frutas estão presentes e sair). Se digitar alguma coisa incorreta irá exibir que a opção está invalida.
...
Alexandre Campos - Etapa COMMAND LINE INTERFACE - Atividade individual Lista de Exercícios - Etapa COMMAND LINE INTERFACE
